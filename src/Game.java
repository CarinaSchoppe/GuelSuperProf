...
public class Game {
    ...
    /**
     * Represents the current instance of the Game class.
     * <p>
     ...
     * of the Game class. If the instance is null, a new instance of the Game class is created; otherwise,
    ...
    /**
     * A private final instance variable representing a list of Cuboid objects.
     *
     * <p>
     * This variable is initialized as an empty ArrayList of Cuboid objects.
    ...
    /**
     * The playingField variable represents the game field, which stores a two-dimensional array of Gamefield objects.
     ...
     * Each element is of type Gamefield, which encapsulates information about the state of that particular position on the game board.
     *
     * Note that Gamefield is not defined in this documentation and should be replaced with the appropriate class name in your implementation.
     *
     ...
     *     Gamefield field = playingField[row][column];
     *     System.out.println(field.getState());
     *
     *   - Updating the state of a specific position on the game board:
     *     playingField[row][column].setState(Gamefield.State.CROSSED);
     *
    ...
    /**
     * The domeList variable represents a private, final ArrayList of type Dome.
     * It is used to store a collection of Dome objects.
     *
     * Dome objects stored in the domeList can be accessed and modified only within the scope
     ...
     *
     * Dome objects can be added to the domeList using the add() method provided by the
     * ArrayList class. Similarly, they can be removed using the remove() method.
     *
     * Example usage:
     *
     *      // Create a new Dome object
     *      Dome dome1 = new Dome();
     *
     *      // Add the Dome object to the domeList
     *      domeList.add(dome1);
     *
     *      // Remove the Dome object from the domeList
     ...
     *
     * Please refer to the documentation of the Player class to understand
     * the structure and attributes of the Player object, as player2 is an
     ...
     * It holds the instance of the Player class representing the current player.
     *
     ...
     *
     * The playing field is a 5x5 grid represented by a 2D array of Gamefield objects. Each Gamefield object represents
     * a cell on the grid and is initialized with its x and y coordinates.
     *
     * The cuboidList is a list of Cuboid objects. The method creates 54 instances of Cuboid and adds them to the list.
     *
     * The domeList is a list of Dome objects. The method creates 18 instances of Dome and adds them to the list.
     *
     ...
     *
     * This method is used to create an instance of the Game class if it does not already exist,
     ...
     *
     * @param player1 The Player object to set as player1.
     */
