...
public class Player {
    ...
    public void moveFigure(Playingfigure playingfigure, Gamefield where) {
        ...
        if (!playingfigure.getOwner().equals(this)) throw new IllegalStateException("ERROR: This figure"
                + " is not part of this player");
        ...
        if (!Game.getInstance().isReachable(playingfigure, where)) throw new IllegalStateException("ERROR: "
                + "This field is not reachable");
