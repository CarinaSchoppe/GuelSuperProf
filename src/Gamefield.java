public class Gamefield extends Gameobject {
    ...
    /**
     * This variable represents an array of Gameobject instances.
     * <p>
    ...
    /**
     * Creates a new instance of the Gamefield class.
     *
    ...
    /**
     * Returns the number of Cuboid objects in the gameobjects list.
     *
     * @return the number of Cuboid objects in the gameobjects list.
     */
    ...
    /**
     * This method checks if any Playingfigure objects are occupying the game board.
     *
    ...
    /**
     * Removes the specified Playingfigure from the game.
     *
     * @param playingfigure the Playingfigure to be removed
     */
